...
public class Enemy {
    ...
    Enemy(int a, int b) throws SlickException {
        ...
        SpriteSheet wrangler = new SpriteSheet("res/wrangler.png",
        ...
        skup.addFrame(wrangler.getSprite(0, 8), 330);

        skup.addFrame(wrangler.getSprite(1, 8), 330);

        skup.addFrame(wrangler.getSprite(2, 8), 330);

        skup.addFrame(wrangler.getSprite(3, 8), 330);

        skup.addFrame(wrangler.getSprite(4, 8), 330);

        skup.addFrame(wrangler.getSprite(5, 8), 330);

        skup.addFrame(wrangler.getSprite(6, 8), 330);

        skup.addFrame(wrangler.getSprite(7, 8), 330);

        skup.addFrame(wrangler.getSprite(8, 8), 330);
        ...
        skdown.addFrame(wrangler.getSprite(0, 10), 330);

        skdown.addFrame(wrangler.getSprite(1, 10), 330);

        skdown.addFrame(wrangler.getSprite(2, 10), 330);

        skdown.addFrame(wrangler.getSprite(3, 10), 330);

        skdown.addFrame(wrangler.getSprite(4, 10), 330);

        skdown.addFrame(wrangler.getSprite(5, 10), 330);

        skdown.addFrame(wrangler.getSprite(6, 10), 330);

        skdown.addFrame(wrangler.getSprite(7, 10), 330);

        skdown.addFrame(wrangler.getSprite(8, 10), 330);
        ...
        skleft.addFrame(wrangler.getSprite(0, 9), 330);

        skleft.addFrame(wrangler.getSprite(1, 9), 330);

        skleft.addFrame(wrangler.getSprite(2, 9), 330);

        skleft.addFrame(wrangler.getSprite(3, 9), 330);

        skleft.addFrame(wrangler.getSprite(4, 9), 330);

        skleft.addFrame(wrangler.getSprite(5, 9), 330);

        skleft.addFrame(wrangler.getSprite(6, 9), 330);

        skleft.addFrame(wrangler.getSprite(7, 9), 330);

        skleft.addFrame(wrangler.getSprite(8, 9), 330);
        ...
        skright.addFrame(wrangler.getSprite(0, 11), 330);

        skright.addFrame(wrangler.getSprite(1, 11), 330);

        skright.addFrame(wrangler.getSprite(2, 11), 330);

        skright.addFrame(wrangler.getSprite(3, 11), 330);

        skright.addFrame(wrangler.getSprite(4, 11), 330);

        skright.addFrame(wrangler.getSprite(5, 11), 330);

        skright.addFrame(wrangler.getSprite(6, 11), 330);

        skright.addFrame(wrangler.getSprite(7, 11), 330);

        skright.addFrame(wrangler.getSprite(8, 11), 330);
        ...
        skwait.addFrame(wrangler.getSprite(0, 14), 733);

        skwait.addFrame(wrangler.getSprite(1, 14), 733);

        skwait.addFrame(wrangler.getSprite(2, 14), 733);

        skwait.addFrame(wrangler.getSprite(3, 14), 733);
        ...
        skdead.addFrame(wrangler.getSprite(2, 20), 733);

        skdead.addFrame(wrangler.getSprite(3, 20), 733);

        skdead.addFrame(wrangler.getSprite(4, 20), 733);

        skdead.addFrame(wrangler.getSprite(5, 20), 733);
